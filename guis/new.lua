...
scarcitybanner.Text = 'Genv was here (Val is black)'
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/skidrewrite/rewriteofayear/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
